...
const ButtonsList = props => (
  ...
  <input type="button" id="division-sign" className="compute btn" value="%" onClick={(e) => props.handleClick(e.target.value)} />
  ...
  <input type="button" id="multiplication-sign" className="compute btn" value="x" onClick={(e) => props.handleClick(e.target.value)} />
  ...
  <input type="button" id="minus-sign" className="compute btn" value="-"  onClick={(e) => props.handleClick(e.target.value)} />
  ...
  <input type="button" id="plus-sign" className="compute btn" value="+" onClick={(e) => props.handleClick(e.target.value)} />
